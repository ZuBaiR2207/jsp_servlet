...
<body>
	<div class="container">
		...
		<div class="logo">
			<a href="IssueBooks.jsp"><img alt="" src="res/logoBack.png"></a>
		</div>
	...
	%>
			...
			<input type="text" value="<%= rs.getString("title_name") %>" name="title_name" class="form-control" />
			</div>
			<div class="form-group">
			<label>Author Name</label>
			<input type="text" value="<%=rs.getString("author_name") %>" class="form-control form-control-sm" name="author_name" />
			</div>
			<div class="form-group">
			<label>Publisher</label>
			<input type="text" value=" <%= rs.getString("publisher_name")%>" class="form-control form-control-sm" name="publisher_name"/>
			</div>
			<div class="form-group">
			<label>Publication</label>
			<input type="text" value="<%= rs.getString("publication") %>" class="form-control form-control-sm" name="publication"/>
			</div> 
			<div class="form-group">
			<label>Genre </label>
			<input type="text" value="<%= rs.getString("genre") %>" class="form-control form-control-sm" name="genre" />
			</div>
			<div class="form-group">
